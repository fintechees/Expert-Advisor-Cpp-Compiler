...
- Use mql_indicator_loader_plugin or mql_ea_loader_plugin to load the compiled js(and Wenassembly). The generated JSON string will be used as the parameter of the plugins.
